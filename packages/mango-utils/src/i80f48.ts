...
This code is from mango-markets v4 client
https://github.com/blockworks-foundation/mango-v4/tree/dev/ts/client
...
export class I80F48 {
   ...
   */
	...
	static MAX_BN: BN = new BN(2).pow(new BN(I80F48.MAX_SIZE)).div(new BN(2)).sub(new BN(1))

	static MIN_BN: BN = new BN(2).pow(new BN(I80F48.MAX_SIZE)).div(new BN(2)).neg()

	data: BN // This is i128 => array of 16 bytes

	static from(dto: { val: BN }): I80F48 {
