		...
		},
		{
			...
			type: {
				...
				fields: [
					...
					{
						name: 'orderStepSize'
						docs: ['the base step size (increment) of orders', 'precision: BASE_PRECISION']
						type: 'u64'
					},
					{
						name: 'orderTickSize'
						docs: ['the price tick size of orders', 'precision: PRICE_PRECISION']
						type: 'u64'
					},
					{
						name: 'minOrderSize'
						docs: ['the minimum base size of an order', 'precision: BASE_PRECISION']
						type: 'u64'
					},
					{
						name: 'maxPositionSize'
						docs: ['the max base size a single user can have', 'precision: BASE_PRECISION']
						type: 'u64'
					},
					{
						name: 'volume24h'
